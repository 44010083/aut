...
public class RestHelloControllerGEThelloParamTest {
    @Autowired
    ...
    @Test
    public void module_1552443330124() throws Exception {
        RequestBuilder questbuild = MockMvcRequestBuilders.get("/hello/param").param("vo","haha");
