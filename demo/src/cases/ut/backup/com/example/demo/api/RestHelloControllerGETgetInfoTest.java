...
public class RestHelloControllerGETgetInfoTest {
    @Autowired
    ...
    @Test
    public void testCase1_1552443330082() throws Exception {
        RequestBuilder questbuild = MockMvcRequestBuilders.get("/hello/h/1");
    ...
    @Test
    public void testCase2_1552443330083() throws Exception {
        RequestBuilder questbuild = MockMvcRequestBuilders.get("/hello/a/2");
        ResultActions r = this.mockMvc.perform(questbuild);
        MvcResult mvcResult = r.andReturn();
        String result = mvcResult.getResponse().getContentAsString();
        assertNotNull("responseContent is null",result);
