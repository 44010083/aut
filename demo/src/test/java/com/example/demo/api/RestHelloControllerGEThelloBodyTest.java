...
public class RestHelloControllerGEThelloBodyTest {
    @Autowired
    ...
    @Test
    public void module_1552443330104() throws Exception {
        RequestBuilder questbuild = MockMvcRequestBuilders.get("/hello/body").contentType(MediaType.APPLICATION_JSON).content("{\"name\": \"1\"}");
